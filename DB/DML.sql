...
-- =====================================================================
-- 9) REQUISITO
--    tipoRequisito: 'O' = Obligatorio (prerrequisito estandar del plan)
-- =====================================================================
INSERT INTO Requisito (idRequisito, tipoRequisito, createdAt, updatedAt, idPlantillaMalla_has_Clase, idClaseRequisito) VALUES
('REQ-001', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC102', 'PMHC-ISC101'),
('REQ-002', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-IN102', 'PMHC-IN101'),
('REQ-003', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC103', 'PMHC-ISC102'),
('REQ-004', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-MM201', 'PMHC-MM110'),
('REQ-005', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-MM201', 'PMHC-MM111'),
('REQ-006', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-MM211', 'PMHC-MM110'),
('REQ-007', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-MM211', 'PMHC-MM111'),
('REQ-008', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-IN103', 'PMHC-IN102'),
('REQ-009', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-MM420', 'PMHC-MM110'),
('REQ-010', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-MM202', 'PMHC-MM201'),
('REQ-011', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-MM202', 'PMHC-MM211'),
('REQ-012', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-FS100', 'PMHC-MM211'),
('REQ-013', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC204', 'PMHC-ISC103'),
('REQ-014', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-MM401', 'PMHC-MM202'),
('REQ-015', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-FS200', 'PMHC-FS100'),
('REQ-016', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-FS200', 'PMHC-MM202'),
('REQ-017', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC211', 'PMHC-MM420'),
('REQ-018', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC211', 'PMHC-MM211'),
('REQ-019', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC211', 'PMHC-ISC103'),
('REQ-020', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-AGE102', 'PMHC-MM401'),
('REQ-021', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-IE326', 'PMHC-FS200'),
('REQ-022', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC321', 'PMHC-MM420'),
('REQ-023', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC351', 'PMHC-AGE102'),
('REQ-024', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC331', 'PMHC-IE326'),
('REQ-025', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC333', 'PMHC-ISC211'),
('REQ-026', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC312', 'PMHC-ISC211'),
('REQ-027', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC312', 'PMHC-ISC204'),
('REQ-028', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC341', 'PMHC-ISC351'),
('REQ-029', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC332', 'PMHC-ISC331'),
('REQ-030', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC334', 'PMHC-ISC333'),
('REQ-031', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC305', 'PMHC-ISC321'),
('REQ-032', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC313', 'PMHC-ISC312'),
('REQ-033', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC306', 'PMHC-ISC341'),
('REQ-034', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC306', 'PMHC-ISC321'),
('REQ-035', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC336', 'PMHC-ISC334'),
('REQ-036', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC407', 'PMHC-ISC305'),
('REQ-037', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC414', 'PMHC-ISC313'),
('REQ-038', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC414', 'PMHC-MM401'),
('REQ-039', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC435', 'PMHC-ISC334'),
('REQ-040', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC435', 'PMHC-ISC332'),
('REQ-041', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC437', 'PMHC-ISC336'),
('REQ-042', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC408', 'PMHC-ISC306'),
('REQ-043', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC408', 'PMHC-ISC407'),
('REQ-044', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC422', 'PMHC-ISC321'),
('REQ-045', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC442', 'PMHC-ISC435'),
('REQ-046', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC443', 'PMHC-ISC306'),
('REQ-047', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC409', 'PMHC-ISC408'),
('REQ-048', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC423', 'PMHC-ISC422'),
('REQ-049', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC415', 'PMHC-ISC305'),
('REQ-050', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC415', 'PMHC-ISC437'),
('REQ-051', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC415', 'PMHC-ISC332'),
('REQ-052', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC445', 'PMHC-ISC443'),
('REQ-053', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC445', 'PMHC-ISC442'),
('REQ-054', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC552', 'PMHC-ISC415'),
('REQ-055', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC552', 'PMHC-ISC445'),
('REQ-056', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC552', 'PMHC-ISC423'),
('REQ-057', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC544', 'PMHC-ISC442'),
('REQ-058', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC544', 'PMHC-ISC306'),
('REQ-059', 'O', SYSDATETIME(), SYSDATETIME(), 'PMHC-ISC546', 'PMHC-ISC445');
GO
